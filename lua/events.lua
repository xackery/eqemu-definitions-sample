...
---@param e BotEventDespawn
function event_despawn(e) end
...
---@param e BotEventEquipItemBot
function event_equip_item_bot(e) end

---@param e BotEventLevelDown
function event_level_down(e) end

---@param e BotEventLevelUp
...
---@param e BotEventSpellBlocked
function event_spell_blocked(e) end
...
---@param e BotEventTimerPause
function event_timer_pause(e) end

---@param e BotEventTimerResume
function event_timer_resume(e) end

---@param e BotEventTimerStart
function event_timer_start(e) end

---@param e BotEventTimerStop
function event_timer_stop(e) end

---@param e BotEventTrade
function event_trade(e) end

---@param e BotEventUnequipItemBot
function event_unequip_item_bot(e) end
...
---@param e ItemEventTimerPause
function event_timer_pause(e) end

---@param e ItemEventTimerResume
function event_timer_resume(e) end

---@param e ItemEventTimerStart
function event_timer_start(e) end

---@param e ItemEventTimerStop
function event_timer_stop(e) end
...
---@param e NPCEventEntityVariableDelete
function event_entity_variable_delete(e) end

---@param e NPCEventEntityVariableSet
function event_entity_variable_set(e) end

---@param e NPCEventEntityVariableUpdate
function event_entity_variable_update(e) end
...
---@param e NPCEventLootAdded
function event_loot_added(e) end
...
---@param e NPCEventTimerPause
function event_timer_pause(e) end

---@param e NPCEventTimerResume
function event_timer_resume(e) end

---@param e NPCEventTimerStart
function event_timer_start(e) end

---@param e NPCEventTimerStop
function event_timer_stop(e) end
...
---@param e PlayerEventAaLoss
function event_aa_loss(e) end

---@param e PlayerEventAltCurrencyGain
function event_alt_currency_gain(e) end

---@param e PlayerEventAltCurrencyLoss
function event_alt_currency_loss(e) end
...
---@param e PlayerEventAugmentInsertClient
function event_augment_insert_client(e) end

---@param e PlayerEventAugmentRemoveClient
function event_augment_remove_client(e) end

---@param e PlayerEventBotCommand
function event_bot_command(e) end

---@param e PlayerEventBotCreate
function event_bot_create(e) end
...
---@param e PlayerEventCombineValidate
function event_combine_validate(e) end
...
---@param e PlayerEventCrystalGain
function event_crystal_gain(e) end

---@param e PlayerEventCrystalLoss
function event_crystal_loss(e) end

---@param e PlayerEventDamageGiven
function event_damage_given(e) end

---@param e PlayerEventDamageTaken
function event_damage_taken(e) end
...
---@param e PlayerEventDestroyItemClient
function event_destroy_item_client(e) end
...
---@param e PlayerEventDropItemClient
function event_drop_item_client(e) end
...
---@param e PlayerEventEntityVariableDelete
function event_entity_variable_delete(e) end

---@param e PlayerEventEntityVariableSet
function event_entity_variable_set(e) end

---@param e PlayerEventEntityVariableUpdate
function event_entity_variable_update(e) end
...
---@param e PlayerEventExit
function event_exit(e) end

---@param e PlayerEventExpGain
function event_exp_gain(e) end
...
---@param e PlayerEventGmCommand
function event_gm_command(e) end
...
---@param e PlayerEventItemClickCastClient
function event_item_click_cast_client(e) end

---@param e PlayerEventItemClickClient
function event_item_click_client(e) end

---@param e PlayerEventLanguageSkillUp
function event_language_skill_up(e) end

---@param e PlayerEventLdonPointsGain
function event_ldon_points_gain(e) end

---@param e PlayerEventLdonPointsLoss
function event_ldon_points_loss(e) end

---@param e PlayerEventLeaveArea
function event_leave_area(e) end

---@param e PlayerEventLevelDown
function event_level_down(e) end
...
---@param e PlayerEventMemorizeSpell
function event_memorize_spell(e) end
...
---@param e PlayerEventRespawn
function event_respawn(e) end

---@param e PlayerEventSay
function event_say(e) end

---@param e PlayerEventScribeSpell
function event_scribe_spell(e) end
...
---@param e PlayerEventSpellBlocked
function event_spell_blocked(e) end

---@param e PlayerEventTargetChange
function event_target_change(e) end

---@param e PlayerEventTaskAccepted
function event_task_accepted(e) end
...
---@param e PlayerEventTimerPause
function event_timer_pause(e) end

---@param e PlayerEventTimerResume
function event_timer_resume(e) end

---@param e PlayerEventTimerStart
function event_timer_start(e) end

---@param e PlayerEventTimerStop
function event_timer_stop(e) end
...
---@param e PlayerEventUnmemorizeSpell
function event_unmemorize_spell(e) end

---@param e PlayerEventUnscribeSpell
function event_unscribe_spell(e) end
...
---@param e SpellEventSpellEffectBuffTicClient
function event_spell_effect_buff_tic_client(e) end

---@param e SpellEventSpellEffectClient
function event_spell_effect_client(e) end
